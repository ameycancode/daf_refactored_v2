...
class EnergyTrainingPipeline:
    ...
    def _encoding_train_test_split(self, df):
        ...
        if 'Load_lag_70_days' in df_copy.columns:
            target_col = 'Load_lag_70_days'
        else:
            raise ValueError("Target column 'Load_lag_70_days' not found")
        ...
        critical_columns = ['Load_I_lag_14_days', 'Temperature']
